<?php
/*
Plugin Name:    Wiser Semantic Structured Data
...
define( 'SDC_NAME', 'structured-data-creator' );
...
require SDC_PLUGIN_DIR . 'lib/plugin-update-checker/plugin-update-checker.php';
$className = PucFactory::getLatestClassVersion('PucGitHubChecker');
$myUpdateChecker = new $className(
    'https://github.com/WiserSites/wiser-structured-data-creator/',
    __FILE__,
    'master'
);
?>